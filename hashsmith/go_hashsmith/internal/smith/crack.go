...
func verifyCandidate(candidate, targetHash, typ, salt, saltMode string) (bool, error) {
	...
	case "p5k2":
		return verifyP5K2(targetHash, candidate)
	case "xsha":
	...
	case "nethalflm":
		return verifyNetHalfLM(targetHash, candidate)
	case "netlmv2":
		return verifyNetLMv2(targetHash, candidate)
	case "mschapv2":
		return verifyMSCHAPv2(targetHash, candidate)
	...
	case "juniper-ive":
		return verifyJuniperIVE(targetHash, candidate)
	case "pdf-user-owner":
	...
	case "odf":
		return verifyODF(targetHash, candidate)
