...
func TestStreamCandidates(t *testing.T) {
	...
	out := captureStdout(t, func() error {
		return streamCandidates("mask", "", "", "", 0, 0, princeDefaultElems, &maskConfig{mask: "?l?d"}, nil, 0, 0, "", 0)
	})
	...
	out = captureStdout(t, func() error {
		return streamCandidates("brute", "", "", "ab", 1, 2, princeDefaultElems, nil, nil, 0, 0, "", 0)
	})
