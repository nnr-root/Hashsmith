...
func TestVendorFormatVectors(t *testing.T) {
	...
	t.Run("AzureSync", func(t *testing.T) {
		// hashcat's own -m 12800 example record and password. The record this
		// replaced was generated by Hashsmith against its own derivation, so it
		// agreed with the implementation by construction and could not have
		// caught the wrong PBKDF2 password this format was using.
		const pass = "hashcat"
		h := "v1;PPH1_MD4,54188415275183448824,100,55b530f052a9af79a7ba9c466dddcb8b116f8babf6c3873a51a3898fb008e123"
		...
		wrongIter := "v1;PPH1_MD4,54188415275183448824,101,55b530f052a9af79a7ba9c466dddcb8b116f8babf6c3873a51a3898fb008e123"
