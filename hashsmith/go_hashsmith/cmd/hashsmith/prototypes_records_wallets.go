...
func webFrameworkPrototypes() []hashid.Prototype {
	return []hashid.Prototype{
		...
		hasPrefixProto("$mobilekeychain$", "1Password 8 mobile keychain", 14,
			"1Password is among the most widely used password managers and its version 8 vaults are a standard extraction target",
			"1password8"),
