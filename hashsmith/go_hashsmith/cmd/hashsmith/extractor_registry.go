...
var universalExtractorRegistry = []extractorDefinition{
	...
	{name: "pcap2smith", input: ".pcap/.pcapng capture", formats: "HTTP Digest, SNMPv3, TACACS+ and TCP-MD5 (the other protocols pcap2john reads are not covered)", run: runExtractPCAP},
