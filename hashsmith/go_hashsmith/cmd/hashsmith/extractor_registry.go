...
var universalExtractorRegistry = []extractorDefinition{
	...
	{name: "pcap2smith", input: ".pcap/.pcapng capture", formats: "HTTP Digest authentication and SNMPv3 (the other protocols pcap2john reads are not covered)", run: runExtractPCAP},
