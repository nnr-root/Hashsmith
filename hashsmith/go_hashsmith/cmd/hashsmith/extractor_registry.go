...
var universalExtractorRegistry = []extractorDefinition{
	...
	{name: "bitcoin2smith", input: "Bitcoin wallet.dat", formats: "Bitcoin Core SQLite wallet", run: runExtractBitcoin},
	...
	{name: "dmg2smith", input: "encrypted Apple DMG", formats: "DMG v1/v2 portable record (export)", run: runExtractDMG},
	...
	{name: "monero2smith", input: "Monero .keys wallet", formats: "Monero portable record (export)", run: runExtractMonero},
