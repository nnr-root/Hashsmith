...
// officePrototypes ports the office, directory and vendor-record branches of
...
func officePrototypes() []hashid.Prototype {
...
// vendorPrototypes ports the remaining office, directory and vendor-record
...
func vendorPrototypes() []hashid.Prototype {
	return []hashid.Prototype{
